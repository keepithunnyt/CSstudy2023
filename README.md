# [Chapter 1: Design Patterns and Programming Paradigms](https://github.com/ddyokim/CSstudy2023/tree/main/1._Design_Patterns_and_Programming_Paradigms)
...
## 4.5 Indexing
   - 4.5.1 Need for Indexing
   - 4.5.2 B-Tree
   - 4.5.3 Creating Indexes
   - 4.5.4 Index Optimization Techniques
## 4.6 Types of Joins
   - 4.6.1 Inner Join
   - 4.6.2 Left Join
   - 4.6.3 Right Join
...
## 4.7 Principles of Joins
   - 4.7.1 Nested Loop Join
   - 4.7.2 Sort-Merge Join
   - 4.7.3 Hash Join
### Expected Questions
</br>
...
## 5.1 Complexity
   ...
   - 5.1.3 Time Complexity in Data Structures
## 5.2 Linear Data Structures
   ...
   - 5.2.4 Stack
   - 5.2.5 Queue
## 5.3 Non-linear Data Structures
   - 5.3.1 Graph
   - 5.3.2 Tree
   - 5.3.3 Heap
   - 5.3.4 Priority Queue
   - 5.3.5 Map
   - 5.3.6 Set
   - 5.3.7 Hash Table
### Expected Questions
